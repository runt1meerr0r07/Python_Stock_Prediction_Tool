...
def launch_stock_dashboard():
    ...
    try:
        ...
        # Create a separate Python process to run the PyQt application
        # This completely avoids the threading issues
        import subprocess
...
from stock_page import StockDashboard
...
if __name__ == "__main__":
    try:
        ...
        # Remove the loading label after a short delay
        ...
        # Remove loading label if there's an error
